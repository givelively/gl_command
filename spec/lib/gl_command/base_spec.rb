...
RSpec.describe GlCommand::Base do
  describe 'NormalizeEin' do
    ...
    describe 'context' do
      ...
      describe 'inspect' do
        let(:target) do
          '<GlCommand::Context \'NormalizeEin\' success: true, error: nil, arguments: {:ein=>nil}, returns: {:ein=>nil}>'
        end
  ...
  describe 'CreateNonprofit' do
    ...
    describe 'context' do
      ...
      describe 'inspect' do
        let(:target) do
          '<GlCommand::Context \'CreateNonprofit\' success: true, error: nil, arguments: {:ein=>nil}, returns: {:nonprofit=>nil}>'
        end
